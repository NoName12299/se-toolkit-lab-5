...
/**
 * Items component that displays a table of items from the backend API.
 */
function Items({ token, onDisconnect }: ItemsProps) {
  ...
  function handleConnect(e: FormEvent) {
    ...
    window.location.reload() // Reload to update token in parent
  }
